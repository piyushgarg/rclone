...
type Home struct {
	...
	OwnerFolderID string  `json:"ownerFolderID"`
...
type Items struct {
	...
	ChildItemsCount string     `json:"childItemsCount,omitempty"`
...
type Folder struct {
	ChildItemsCount string     `json:"childItemsCount"`
	CreatedBy       CreatedBy  `json:"createdBy"`
	CreatedTime     time.Time  `json:"createdTime"`
	ErrorCode       string     `json:"errorCode"`
	ID              string     `json:"id"`
...
// FileCopyBody is the request for Copy File
...
type UploadFile struct {
	ParentID            string `json:"parentID"`
	//DuplicateResolution string `json:"duplicateResolution"`
}
